...
The core idea is to flatten complex objects into simple binary files accompanied by a JSON summary.
...
- **`content`**: A monolithic binary file containing compressed chunks of data.
